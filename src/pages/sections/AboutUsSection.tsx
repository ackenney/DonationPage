    ...
    <Section id="about-us" className="bg-neutral-100">
      <div className="w-full lg:max-w-7xl lg:mx-auto grid lg:grid-cols-2 gap-8 p-8 lg:py-28">
        ...
        <div className="flex flex-col items-start">
          <span className="text-xs lg:text-sm text-TextColor1 tracking-widest">ABOUT US</span>
          <h2 className="text-3xl lg:text-5xl text-TextColor2 font-bold">Maroon Strategy</h2>
          <p className="py-4 leading-loose text-TextColor2 lg:leading-9">
